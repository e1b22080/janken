package oit.is.z2636.kaizi.janken.security;
...
public class JankenAuthConfiguration {
  ...
  public InMemoryUserDetailsManager userDetailsService() {
    ...
    UserDetails user1 = User.withUsername("user1")
        .password("{bcrypt}$2y$05$4iOzA8g0.X5TAyX.xm7qDO9irUpH7cBNC8XkT0k627PG7V6N05Vp2").roles("USER").build();
    ...
    UserDetails igaki = User.withUsername("いがき")
        .password("{bcrypt}$2y$05$I/7e/E8bdjERkIQOEsvLlO9OrLNFOWXH9b0GddwJSyH2RDaDzqy8K").roles("USER").build();
